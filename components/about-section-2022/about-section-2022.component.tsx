...
interface IProps {
	transformYDORange: number[]
	transformYTRange: number[]
}


const AboutSection = ({transformYDORange, transformYTRange}: IProps) => {
	const { scrollYProgress } = useViewportScroll()

	// const tr
	// ansformOpacity = useTransform(scrollYProgress, [0.13, 0.2], [1, 0])

	const transformYDO = useTransform(scrollYProgress, transformYDORange, [0, 60])

	const transformYT = useTransform(scrollYProgress, transformYTRange, [0, -40])
