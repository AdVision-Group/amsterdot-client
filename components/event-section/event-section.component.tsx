...
const EventSection = () => {
	...
	const transformCON = useTransform(scrollYProgress, [0.12, 0.3], [-100, 0])
	const transformFERE = useTransform(scrollYProgress, [0.12, 0.3], [50, -50])
	const transformNCE = useTransform(scrollYProgress, [0.12, 0.3], [-50, 0])
