...
const EventSection = () => {
	...
	const transformCON = useTransform(scrollYProgress, [0.17, 0.48], [-50, 50])
	const transformFERE = useTransform(scrollYProgress, [0.17, 0.48], [50, -50])
	const transformNCE = useTransform(scrollYProgress, [0.17, 0.48], [-50, 0])
